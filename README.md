...
Use arrow keys to activate appropraite areas. Use shift to do the same.


<br>

2. **What creative additions did you make? How can we find them?**
You must use a combination of shift and arrow keys at the same time in certain parts of the song.
...
https://www.youtube.com/watch?v=uOIrfUqWHdE&t=316s


<br>

7. **What trouble did you have with this project?**
I couldn't get the menue screen to show up when the player dies, and I couldn't get the healthbar to slide.


<br>

8. **Is there anything else we should know?**
I had to switch to unity 2D to do this, because the sprites I needed weren't available in 3D.
